...
\rm Inst  & Name              & FMT   & \rm Opcode & \rm funct3 & \rm funct5 & \rm Description (C)         & Note \\ \hline
lr.w      & Load Reserved     & R     & 0101111    & 0x2    & 0x02   & rd = M[rs1]; reserve = 1 & \\
...
amominu.w & Atomic MIN (U)    & R     & 0101111    & 0x2    & 0x18   & rd = M[rs1]; M[rs1] = min(rd, rs2) & unsigned cmp \\
amomaxu.w & Atomic MAX (U)    & R     & 0101111    & 0x2    & 0x1C   & rd = M[rs1]; M[rs1] = max(rd, rs2) & unsigned cmp \\
\hline
\end{tabular}
\end{center}
